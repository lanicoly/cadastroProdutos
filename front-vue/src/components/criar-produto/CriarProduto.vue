      ...
      <div class="space-y-3 min-w-[40%]">
        ...
        <form @submit.prevent="createProdutos" class="flex flex-col gap-3 bg-white rounded-lg p-3 shadow-shape mx-2">
          ...
          <fieldset class="flex flex-col">
            ...
            <input v-model="newProduto.descricao"
          ...
          <fieldset class="flex flex-col">
            ...
            <input v-model="newProduto.marca"
              class="bg-gray-100 border-solid border-2 rounded-sm placeholder-slate-500 text-xs py-1.5 px-2" type="text"
          ...
          <div class="flex gap-3 justify-between flex-wrap min-w-[230px]">
            ...
            <fieldset class="flex flex-col flex-1">
              ...
              <input v-model="newProduto.valor"
            ...
            <fieldset class="flex flex-col flex-1">
              ...
              <input v-model="newProduto.quantidade"
          ...
          <input
            class="bg-teal-600 hover:bg-orange-600 cursor-pointer transition-all delay-75 px-3 py-1 rounded-lg text-white font-semibold"
